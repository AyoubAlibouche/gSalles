		...
		<!-- partial -->
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card">
						<div class="card-body">
							<h3 class="card-title">Gestion des Salles</h3>
							<div class="form-group">
								<label for="exampleInputEmail1">Code :</label> <input
									type="text" class="form-control" name="code" id="code"
									aria-describedby="emailHelp" placeholder="Enter le code">

							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Capacite :</label> <input
									type="text" class="form-control" name="capacite" id="capacite"
									placeholder="Enter la capacité">
							</div>
